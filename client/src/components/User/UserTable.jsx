...
const UserTable = ({ users = [] }) => {
    ...
    const filteredUsers = users.filter((user) => {
        ...
        const matchesStatus =
            filterStatus === "all" ||
            (filterStatus === "activec" && user.is_active) ||
    ...
    return (
        <>
            <div className="w-full bg-gray-900 rounded-lg border border-gray-600 shadow-lg overflow-hidden">
                {/* filtered section */}
                <div>
                    <div className="flex flex-col sm:flex-row gap-3">
                        <div className="flex-1 relative">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-2 bg-gray-800
                ...
                <div className="overflow-x-auto">
                    <table className="w-full">
                        <thead className="bg-gray-800/5 border-b border-gray-700">
                            <tr>
                ...
                {/* footer sectio */}
                <div className="px-6 py-4 bg-gray-800/30 border-t 
                    border-gray-800 flex items-center justify-between text-sm text-gray-400">
                    <p>
                        Showing {filteredUsers.length} of {users.length} users
                    </p>
                    <div className="flex gap-4">
                        <button className="text-gray-300 hover:text-white transitions-colors">
                            ← Previous
                        </button>
                        <button className="text-gray-300 hover:text-white transitions-colors">
                            Next →
